...
let tamammi = db.fetch(`tamammi_${message.author.id}`)
if (!tamammi && (command !== "tamam" && command !== "")) return message.reply("Hop dur destek sunucumuz açıldı gelmek için Linkimiz Burda https://discord.gg/fKXdU2m9hA Eğer Geldiysen **xd?tamam** yaz")
