...
exports.run = async(client, message, args) => {
 ...
 .setColor(`RED`)
 .setDescription(`**${karaliste}** sebebiyle karalisteye alınmışsın!\nBeyaz listeye alınmak istiyorsan Yetkililere söyle`)
  if(karaliste) 
...
if(message.author.id != "809412681940860988") return message.channel.send(bakim)
